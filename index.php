    ...
    $.ajax({
        ...
        success:function(para)
        {
            ...
            if(para != 'nodata')
            {
                ...
                {
                    var str = '<a href="./routes.php?product"><div id="cardDiv" class="col-lg-3 col-sm-2"><div class="properties" style="border:2px solid grey;border-radius:3px;"><div class="image-holder" style="width:100%;height:100%;"><img src="storage/posts/'+para[i][3]+'" id="imgcard" class="img-responsive" alt="properties"><a class="patch sale" href="#" style="color:black;"><div class="thepatch">Featured</div><div class="patch-background"> </div></a><ul class="featured__item__pic__hover favorites"><li><a href="#"><i class="fa fa-heart"></i></a></li><li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i></i></a></li></ul><p class="price">₹'+para[i][1]+'</p><p class="title"> '+para[i][0]+'</p><p class="title"> '+para[i][2]+'</p></div></div></div></a>'
                    $('#pcards').append(str)
                }
            }
            else
...
$('#bulkproducts').click(function(){
    $('#allb').text("Bulk Product Listing")
