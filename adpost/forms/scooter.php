...
<nav class="navbar navbar-expand-sm  fixed-top">
  ...
  <a class="navbar-brand" href="#" style="font-size: 20px;">Logo</a>
          ...
          <section class="row justify-content-center">
            <section class="col-12 col-sm-2 col-md-8 col-lg-6">
              <form>
                ...
                <p class="terms">Scooters</p>
                <hr>
		<p class="includedet">
			INCLUDE SOME DETAILS</p>
	...
	<form action="/action_page.php">
    <div class="tab-content">
      <label for="year" id="years">Years*</label>
      <select  id="State" name="sellist1">
        <option>1</option>
        <option>2</option>
        <option>3</option>
		...
		<div class="Transmission ABC">
			  	<label>Transmission*</label>
			  	<br>
			  	 <div class="radio"> 
        <div class="btn btn-group  btn-lg btn-group-toggle" 
            data-toggle="buttons"> 
             <label class="btn btn-lg btn-dark active"> 
                <input type="radio" name="button" 
                    id="button2" autocomplete="off">  
                  Automatic
            </label> 
            <label class="btn btn-dark btn-lg btn-lg active"> 
                <input type="radio" name="button" 
                    id="button2" autocomplete="off">  
                Manual
            </label> 
		</div>
	    <div class="orders ABC">
		...
		<div class="tab-content">
  		<label for="usr" id="KMdriven">KM Driven:</label>
	...
	<div id="imgset1">
              ...
              <div id="imgset1">
                ...
                <div id="upload_button">
                  <label>
                      <input type="file" class="images" name="img12" id="imge12" accept="image/*" multiple="false" value="1" onchange="checkUpload(this.id,this.name)">
